import { IAddressData } from "@/interfaces/address-data.interface";
...
interface BillingDataFormProps {
  ...
  onChange: (address: IAddressData) => void;
}

export function BillingDataForm(props: BillingDataFormProps) {
